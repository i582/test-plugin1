...
public class TactDefaultFieldValueImpl extends TactCompositeElementImpl implements TactDefaultFieldValue {

  public TactDefaultFieldValueImpl(@NotNull ASTNode node) {
    super(node);
  }
