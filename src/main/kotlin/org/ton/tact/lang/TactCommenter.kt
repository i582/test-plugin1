...
class TactCommenter : CodeDocumentationAwareCommenterEx, SelfManagingCommenter<TactCommenter.TactCommenterDataHolder> {
    ...
    override fun getBlockCommentRange(selectionStart: Int, selectionEnd: Int, document: Document, data: TactCommenterDataHolder): TextRange? {
