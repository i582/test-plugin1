...
import org.ton.tact.lang.psi.impl.TactCachedReference
...
object TactCompletionPatterns {
    ...
    fun onAttributeIdentifier(): PsiElementPattern.Capture<PsiElement> {
        return psiElement().withParent(TactAttributeIdentifier::class.java)
    }

    /**
     * Element inside attribute struct field like:
     *
     *    struct A {
     *      #[<caret>]
     *      field string
    ...
    fun onFieldAttributeIdentifier(): PsiElementPattern.Capture<PsiElement> {
        return psiElement()
            .withParent(TactAttributeIdentifier::class.java)
            .inside(TactFieldDeclaration::class.java)
    }
