package org.ton.tact.lang.completion.sort
...
import org.ton.tact.lang.completion.TactLookupElement
...
val SPAWN_COMPLETION_WEIGHERS: List<Any> = listOf(
    ...
    preferTrue(TactLookupElementProperties::isNotDeprecated, id = "tact-prefer-not-deprecated"),
    preferTrue(TactLookupElementProperties::accessedNotViaOption, id = "tact-prefer-accessed-not-via-option"),
    ...
    preferTrue(TactLookupElementProperties::isTypeCompatible, id = "tact-prefer-compatible-type"),
    preferTrue(TactLookupElementProperties::isLocal, id = "tact-prefer-locals"),
    preferTrue(TactLookupElementProperties::isSameModule, id = "tact-prefer-same-module"),
