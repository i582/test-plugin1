package org.ton.tact.lang.doc.psi.impl
...
import org.ton.tact.lang.doc.psi.*
import org.ton.tact.lang.psi.StringLiteralEscaper
import org.ton.tact.lang.psi.impl.TactElementFactory
import org.ton.tact.utils.ancestorStrict
import org.ton.tact.utils.childOfType
import org.ton.tact.utils.getPrevNonWhitespaceSibling
...
class TactDocCodeFenceImpl(type: IElementType) : TactDocElementImpl(type), TactDocCodeFence {
    ...
    /**
     * Handles changes in PSI injected to the comment (see [TactDoctestLanguageInjector]).
