...
import org.ton.tact.lang.psi.TactMessageDeclaration
import org.ton.tact.lang.stubs.index.TactNamesIndex

open class TactMessageTypeEx(private val name: String, anchor: PsiElement?) :
    TactResolvableTypeEx<TactMessageDeclaration>(anchor), TactImportableTypeEx {
